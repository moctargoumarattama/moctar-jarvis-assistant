...
class Ui_Widget(object):
    ...
    def setupUi(self, Widget):
        ...
        self.retryBtn.setStyleSheet("border-image: url(D:/BSc CSD Sem 6/Project/JarvisGUI/JarvisImages/retryButton.png);")
        self.retryBtn.setText("")
        self.retryBtn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.loginBtn.setStyleSheet("border-image: url(D:/BSc CSD Sem 6/Project/JarvisGUI/JarvisImages/retryButton.png);\n"
                                    "border-image: url(D:/BSc CSD Sem 6/Project/JarvisGUI/JarvisImages/loginButton.png);")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("D:/BSc CSD Sem 6/Project/JarvisGUI/JarvisImages/loginFailed.gif"))
        self.label.setScaledContents(False)
        self.label.setObjectName("label")
        self.NewUserBtn = QtWidgets.QPushButton(self.frame)
        self.NewUserBtn.setGeometry(QtCore.QRect(390, 390, 171, 61))
        self.NewUserBtn.setStyleSheet("border-image: url(D:/BSc CSD Sem 6/Project/JarvisGUI/JarvisImages/newUser.png);")
