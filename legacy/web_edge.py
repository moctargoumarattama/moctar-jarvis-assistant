...
# Function to activate the Edge window
def activate_edge_window():
    pyautogui.click(x=300, y=300)  # Click somewhere on the screen to activate Edge
...
# Driver program
def main(ip):
    initialize_edge_driver()
    t2s.text2speech(engine, "opening edge")
    driver.get("https://www.google.com/")
    while True:
        print("edge control")
        command = (s2t.voice2text("en")).lower()
        print("edge control"+command)
